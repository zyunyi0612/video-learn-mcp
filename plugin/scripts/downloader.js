...
export async function downloadVideo(input, outputDir, config) {
...
function getCertEnv() {
    try {
        const certPath = resolve(homedir(), "Library/Python/3.11/lib/python/site-packages/certifi/cacert.pem");
